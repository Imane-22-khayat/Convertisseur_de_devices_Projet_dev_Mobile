...
public class MainActivity extends AppCompatActivity {
    ...
    public String getConversionRate(String convert_from_value, String convert_to_value, Double edit_amount_to_convert_value) {
        ...
        String url = "https://v6.exchangerate-api.com/v6/68f2b16bcd82a4137b9a0626/pair/" + convert_from_value + "/" + convert_to_value + "/" + edit_amount_to_convert_value;
        ...
        StringRequest stringrequest = new StringRequest(Request.Method.GET, url, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    String conversion_value = "" + round(((Double) jsonobject.get("conversion_result")), 2);
